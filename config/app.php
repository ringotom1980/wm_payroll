...
$env = fn($k, $d = null) => (($v = getenv($k)) !== false && $v !== '') ? $v : $d;
...
return [
    ...
    'DB' => [
        ...
        'USER'      => $env('DB_USER', 'u327657097_wm_payroll_user'),
        'PASS'      => $env('DB_PASS', ''),
    ...
    // Session/Cookie
    'SESSION' => [
        'NAME'        => $env('SESSION_NAME', 'wm_payroll_sid'),
        'LIFETIME'    => (int)$env('SESSION_LIFETIME', '1440'), // 秒
        'SAMESITE'    => $env('COOKIE_SAMESITE', 'Lax'),        // Lax / Strict / None
